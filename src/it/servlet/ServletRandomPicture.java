...
public class ServletRandomPicture extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //显示到浏览器
        showToBrowner(response, bufferedImage);
    ...
    private void showToBrowner(HttpServletResponse response, BufferedImage bufferedImage) throws IOException {
    ...
    private void drawRandomNum(Graphics2D graphics) {
        ...
        String BASE =
                "\u7684\u4e00\u4e86\u662f\u6211\u4e0d\u5728\u4eba\u4eec\u6709\u6765\u4ed6\u8fd9\u4e0a\u7740\u4e2a\u5730\u5230\u5927\u91cc\u8bf4\u5c31\u53bb\u5b50\u5f97"
                        ...
                        + "\u9876\u6025\u6797\u505c\u606f\u53e5\u533a\u8863\u822c\u62a5\u53f6\u538b\u6162\u53d4\u80cc\u7ec6";
        for (int i = 0; i < 4; i++) {
            double theta = (new Random().nextInt() % 30) * Math.PI / 180;  //%30 取得是 -30 到 30 的区间 ，模以30肯定比30小

            int nextInt = new Random().nextInt(BASE.length());
            char c = BASE.charAt(nextInt);
            String ch = c + "";
            graphics.rotate(theta, x, 40);
